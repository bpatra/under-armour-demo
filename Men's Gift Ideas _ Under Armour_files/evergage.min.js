...
Evergage.cashDom(function () {
    if (uaDatalayer.getPageData()) {
        if ((uaDatalayer.getPageData().site_country_code === "US") && (uaDatalayer.getPageData().site_shipto_country === "United States")) {
            Evergage.init({
                cookieDomain: "underarmour.com"
            }).then(() => {
            
                const config = {
                    global: {
                        contentZones: [
                            { name: "global_navigation_banner_men", selector: "div.b-navigation-flyout_wrapper div[aria-label='men'] div.b-navigation_banner-container" },
                            { name: "global_navigation_banner_women", selector: "div.b-navigation-flyout_wrapper div[aria-label='women'] div.b-navigation_banner-container" },
                            { name: "global_navigation_banner_kids", selector: "div.b-navigation-flyout_wrapper div[aria-label='kids'] div.b-navigation_banner-container" },
                            { name: "global_navigation_banner_shoes", selector: "div.b-navigation-flyout_wrapper div[aria-label='footwear'] div.b-navigation_banner-container" },
                            { name: "global_navigation_banner_sports", selector: "div.b-navigation-flyout_wrapper div[aria-label='sport'] div.b-navigation_banner-container" },
                            { name: "global_navigation_banner_outlet", selector: "div.b-navigation-flyout_wrapper div[aria-label='outlet'] div.b-navigation_banner-container" },
                            { name: "global_header_banner", selector: "div.l-header-section_top div.b-header-banner div.promo-banner__wrapper div.promo-banner-slider" },
                            { name: "global_promo_banner", selector: "div.b-global-message-banner__wrapper div.promo-banner__wrapper div.js-promo-header-banner.promo-banner__slide-0" },
                            { name: "global_aa_testing" },
                            { name: "global_popup" }
                        ],
                        listeners: [
                            /* Listeners for email signup change */
                            Evergage.listener("click", ".b-footer_signup-button.js-signup-submit", (evt) => {
                                if (uaDatalayer.getPageData().customer_id === undefined) {
                                    Evergage.sendEvent({
                                        action: 'New Email Signup',
                                        user: {
                                            attributes: {
                                                emailAddress: Evergage.cashDom(".b-footer_signup-input.g-input.js-signup-email.js-custom-input").val().trim()
                                            }
                                        }
                                    });
                                }
                                if (uaDatalayer.getPageData().customer_id !== undefined) {
                                    Evergage.sendEvent({
                                        action: 'Form Email Signup',
                                        user: {
                                            attributes: {
                                                formEmail: Evergage.cashDom(".b-footer_signup-input.g-input.js-signup-email.js-custom-input").val().trim()
                                            }
                                        }
                                    });
                                }
                            }),
                            Evergage.listener("click", ".btn.btn-primary.btn-block.js-createaccount-button.g-button_base.g-button_primary--black", (evt) => {
                                if (Evergage.cashDom(".b-return-wrap.registration .form-group.g-checkbox .g-checkbox-input")[0].checked === true) {
                                    if (uaDatalayer.getPageData().customer_id === undefined) {
                                        Evergage.sendEvent({
                                            action: 'New Email Signup',
                                            user: {
                                                attributes: {
                                                    emailAddress: Evergage.cashDom(".form-control.order-return-form-input.b-quantity-select.js-custom-input").val().trim()
                                                }
                                            }
                                        });
                                    }
                                    if (uaDatalayer.getPageData().customer_id !== undefined) {
                                        Evergage.sendEvent({
                                            ...
                                            user: {
                                                attributes: {
                                                    formEmail: Evergage.cashDom(".form-control.order-return-form-input.b-quantity-select.js-custom-input").val().trim()
                                                }
                                            }
                                        });
                                    }
                            ...
                            Evergage.listener("click", ".email-pop-up_signup-button", (evt) => {
                                if (uaDatalayer.getPageData().customer_id === undefined) {
                                    Evergage.sendEvent({
                                        action: 'New Email Signup',
                                        user: {
                                            attributes: {
                                                emailAddress: Evergage.cashDom(".b-input_row-input.form-control.js-signup-email.js-custom-input").val().trim()
                                            }
                                        }
                                    });
                                }
                                if (uaDatalayer.getPageData().customer_id !== undefined) {
                                    Evergage.sendEvent({
                                        ...
                                        user: {
                                            attributes: {
                                                formEmail: Evergage.cashDom(".b-input_row-input.form-control.js-signup-email.js-custom-input").val().trim()
                                            }
                                        }
                                    });
                                }
                            }),
                            /* Listener for global fly-away cart item remove */
                            Evergage.listener("click", ".b-header_minicart-item-list .b-header_minicart-remove-item .remove-btn", (evt) => {
                                var uuidToEdit = evt.target.parentElement.getAttribute("data-uuid");
                                const country = uaDatalayer.getPageData() ? uaDatalayer.getPageData().site_country_code : "US";
                                const lineItem = {
                                    _id: country + evt.target.parentElement.getAttribute("data-product-style"),
                                    quantity: 0, //parseInt(Evergage.cashDom(".b-header_minicart-card.card.uuid-" + uuidToEdit + ".js-cmp-inited.js-cmp-cartTile .b-header_minicart-item-attributes .b-header_minicart-item-quantity .pricing.qty-card-quantity-count.bfx-minicart-product-qty")[0].innerHTML),
                                    price: 0 //parseFloat(Evergage.cashDom("div.b-header_minicart-total-price > div > span.pricing.line-item-total-price-amount.bfx-price.bfx-minicart-product-subtotal.item-total-" + uuidToEdit)[0].innerText.replace("$", "").replace("/n", "").trim())
                                };
                                Evergage.sendEvent({
                        ...
                        onActionEvent: (actionEvent) => {
                            ...
                            if (uaDatalayer.getPageData()) {
                                loginCheck = uaDatalayer.getPageData().phx_login_success_lastpageview || false;
                                // ACS - This code does not do anything.
                                // if (loginCheck === true) {
                                //     action: 'Login';
                                // }
                                actionEvent.user = actionEvent.user || {};
                                // ACS - Small change to only set ID when there definitely is a value, do not send a null or undefined value for ID. 
                                const customerId = uaDatalayer.getPageData().customer_id;
                                if(customerId) actionEvent.user.id = customerId;
                                // actionEvent.user.id = uaDatalayer.getPageData().customer_id || null;
                                                         
                                actionEvent.user.attributes = actionEvent.user.attributes || {};
                                actionEvent.user.attributes.userRegion = uaDatalayer.getPageData().site_country_code || null;
                                actionEvent.user.attributes.uiLoggedStatus = uaDatalayer.getPageData().logged_in_status || null;
                                actionEvent.user.attributes.language = uaDatalayer.getPageData().site_language || null;
                                actionEvent.user.attributes.shipToCountry = uaDatalayer.getPageData().site_shipto_country || null;
                                actionEvent.user.attributes.siteCurrency = uaDatalayer.getPageData().site_currency || null;
                            }
                            return actionEvent;
                        }
                    },
                    ...
                    pageTypes: [
                        {
                            name: "home",
                            action: "Homepage",
                            isMatch: () => uaDatalayer.getPageData().site_section === "Home",
                            contentZones: [
                                { name: "homepage_hero", selector: "#cm-placement-primary" },
                                { name: "homepage_freeform", selector: "#cq_recomm_slot-813b3d369d339a63a86c305881" },
                                { name: "homepage_aa_testing" }
                            ],
                            listeners: [
                                Evergage.listener("click", ".js-cmp-signUp .js-signup-submit", (evt) => {
                                    if (uaDatalayer.getPageData().customer_id === undefined) {
                                        Evergage.sendEvent({
                                            action: 'New Email Signup',
                                            user: {
                                                attributes: {
                                                    emailAddress: Evergage.cashDom(".js-signup-container .js-signup-email").val().trim()
                                                }
                                            }
                                        });
                                    }
                                    if (uaDatalayer.getPageData().customer_id !== undefined) {
                                        Evergage.sendEvent({
                                            ...
                                            user: {
                                                attributes: {
                                                    formEmail: Evergage.cashDom(".js-signup-container .js-signup-email").val().trim()
                                                }
                                            }
                                        });
                                    }
                        ...
                        },
                        {
                            name: "department",
                            action: "Department",
                            isMatch: () => uaDatalayer.getPageData().site_section === "Department" && uaDatalayer.getPageData().page_type === "content"
                        },
                        {
                            name: "grid_page",
                            action: "Grid_Page",
                            isMatch: () => uaDatalayer.getPageData().site_section === "Product Refinement" && uaDatalayer.getPageData().page_type === "product-listing" && Evergage.cashDom(".b-breadcrumbs-list .b-breadcrumbs-item a").length > 0,
                            catalog: {
                                Category: {
                                    _id: Evergage.resolvers.buildCategoryId(".b-breadcrumbs-list .b-breadcrumbs-item a", null, null, (categoryId) => categoryId.toUpperCase())
                                }
                            },
                            listeners: [
                                Evergage.listener("click", "#bodyPage", (evt) => {
                                    var refined = 0;
                                    var eventType = "";
                                    var filterText = "";
                                    // ACS - Extra comma is throwing an error.
                                    // var regexAdd = new RegExp("b-refinements_attributes-.* m-selected", ); 
                                    // var regexDel = new RegExp("b-refinements_attributes-.*", );
                                    var regexAdd = new RegExp("b-refinements_attributes-.* m-selected");
                                    var regexDel = new RegExp("b-refinements_attributes-.*");
                                    /* Favoriting */
                                    if (evt.target.className.trim() === "js-whislist-icon b-tile-fav_button" || evt.target.className.trim() === "b-tile-fav_button js-whislist-icon") {
                                        Evergage.sendEvent({
                                            action: "Add to Favorites",
                                            itemAction: Evergage.ItemAction.Favorite,
                                            catalog: {
                                                Product: {
                                                    _id: uaDatalayer.getPageData().site_country_code + evt.target.parentElement.getAttribute("data-pid")
                                                }
                                            }
                                        }
                                        );
                                    ...
                                    /* Adding filters */
                                    if (regexAdd.test(evt.target.className) === true && evt.target.innerHTML.length > 0) {
                                        refined = 1;
                                        eventType = 'Filter Added';
                                        filterText = evt.target.innerHTML.replace(/(\r\n|\n|\r)/gm, "");
                                    }
                                    if (evt.target.className == "b-swatches_circle-link m-active") {
                                        refined = 1;
                                        eventType = 'Filter Added';
                                        filterText = evt.target.getAttribute("data-analytics-plp-filter-value");
                                    }
                                    if (evt.target.parentElement.className === "b-refinements_price-btn m-selected" && evt.target.className === "bfx-price" && evt.target.innerHTML.length > 0) {
                                        refined = 1;
                                        eventType = 'Filter Added';
                                        filterText = evt.target.innerHTML.replace(/(\r\n|\n|\r)/gm, "");
                                    }
                                    /* Removing filters */
                                    if (regexDel.test(evt.target.className) === true && regexAdd.test(evt.target.className) === false && evt.target.innerHTML.length > 0) {
                                        eventType = 'Filter Removed';
                                        filterText = evt.target.innerHTML.replace(/(\r\n|\n|\r)/gm, "");
                                        if (filterText.length < 256) {
                                            refined = 1;
                                        }
                                    }
                                    if (evt.target.className == "b-swatches_circle-link") {
                                        refined = 1;
                                        eventType = 'Filter Removed';
                                        filterText = evt.target.getAttribute("data-analytics-plp-filter-value");
                                    }
                                    if (evt.target.parentElement.className === "b-refinements_price-btn" && evt.target.className === "bfx-price" && evt.target.innerHTML.length > 0) {
                                        refined = 1;
                                        eventType = 'Filter Removed';
                                        filterText = evt.target.innerHTML.replace(/(\r\n|\n|\r)/gm, "");
                                    }
                                    if (evt.target.className === "b-refinements_swatch-remove" && evt.target.innerHTML.length > 0) {
                                        refined = 1;
                                        eventType = 'Filter Removed';
                                        filterText = evt.target.innerHTML.replace(/(\r\n|\n|\r|Remove filter )/gm, "");
                                    }
                                    ...
                                    if (refined == 1) {
                                        Evergage.sendEvent({
                                            action: 'Product Search Refinement',
                                            catalog: {
                                                Refinement: {
                                                    dimensions: {
                                                        Change: [eventType],
                        ...
                        },
                        {
                            name: "pdp",
                            action: "View",
                            isMatch: () => uaDatalayer.getPageData().site_section === "Product Detail" && uaDatalayer.getPageData().page_type === "product-detail",
                            contentZones: [
                                { name: "pdp_product_recommendations", selector: "div.b-product-slot.m-slot_4 > div.g-carousel.js-recommendation-wrapper.recommendations-section.js-cmp-inited.js-cmp-loadProducts > div" },
                                { name: "pdp_aa_testing" },
                                { name: "pdp_pid_aa_testing" }
                            ],
                            catalog: {
                                Product: {
                                    _id: () => {
                                        const product = uaDatalayer.getPageData().site_country_code + uaDatalayer.getPageData().products[0].product_style;
                                        if (product.length > 0) {
                                            return product;
                                        }
                                    },
                                    categories: Evergage.resolvers.buildCategoryId(".b-breadcrumbs-list .b-breadcrumbs-item a", null, null, (categoryId) => [categoryId.toUpperCase()]),
                                    currency: () => { return uaDatalayer.getPageData().site_currency; },
                                    listPrice: () => {
                                        var listDL = parseFloat(uaDatalayer.getPageData().products[0].product_msrp);
                                        return (listDL > 0) ?  listDL : null; 
                                    },
                                    name: () => { return uaDatalayer.getPageData().products[0].product_name; },
                                    numRatings: () => { return uaDatalayer.getPageData().products[0].product_review_count; },
                                    /* Commented out as we do not want to update catalog price with per-customer price values
                                    price: () => { 
                                        var priceDL = parseFloat(uaDatalayer.getPageData().products[0].product_price); 
                                        return (priceDL > 0) ? priceDL : null;
                                    },
                                    */
                                    rating: () => { return uaDatalayer.getPageData().products[0].product_rating; },
                                    url: () => Evergage.resolvers.fromHref(),
                                    dimensions: {
                                        Country: () => { return [uaDatalayer.getPageData().site_country_code]; },
                                        Gender: () => { return [uaDatalayer.getPageData().products[0].product_gender]; },
                                        Color: Evergage.resolvers.fromSelectorAttributeMultiple(".b-swatches_circle-link.m-active", "title", (pColor) => { if (Evergage.cashDom(".b-swatches_circle-link.m-active").length > 0) { return [pColor[0].substring(0, pColor[0].indexOf('-'))] } }),
                                        ProductType: () => { return [uaDatalayer.getPageData().pdp_type]; },
                                        Silhouette: () => { return [uaDatalayer.getPageData().products[0].product_silhouette]; },
                                        //Do not collect size on page load, as size is never selected by default on page load
                                        //Size: Evergage.resolvers.fromSelectorAttributeMultiple(".js-size-select", "data-attr-value")
                                    }
                                }
                            },
                            listeners: [
                                /* Listener for color change */
                                Evergage.listener("click", "a.b-swatches_circle-link", (evt) => {
                                    if (evt.target) {
                                        if (evt.target.getAttribute("title")) {
                                            Evergage.sendEvent({
                                                ...
                                                catalog: {
                                                    Product: {
                                                        _id: uaDatalayer.getPageData().site_country_code + uaDatalayer.getPageData().products[0].product_style,
                                                        dimensions: {
                                                            // Tentative switch to title instead of alt, as this seems to better capture colors in more cases, although it needs parsed as client does not want color code ID
                                                            Color: [evt.target.getAttribute("title").substring(0, evt.target.getAttribute("title").indexOf('-'))]
                                                        }
                                                    }
                                                }
                                            });
                                ...
                                Evergage.listener("click", ".b-select-size-outer", (evt) => {
                                    if (evt.target) {
                                        if (evt.target.innerHTML.length > 0 && evt.target.getAttribute("data-attr-value")) {
                                            Evergage.sendEvent({
                                                action: "View",
                                                itemAction: Evergage.ItemAction.ViewItemDetail,
                                                catalog: {
                                                    Product: {
                                                        _id: uaDatalayer.getPageData().site_country_code + uaDatalayer.getPageData().products[0].product_style,
                                                        dimensions: {
                                                            Size: [evt.target.innerHTML.trim()] // Cannot use evt.target.dataset.attrValue as it doesn't match the SKU size coding on some product types
                                                        }
                                                    }
                                                }
                                            });
                                ...
                                /* Listener for wishlist add */
                                Evergage.listener("click", ".b-product_name-fav_defultButton", (evt) => {
                                    if (evt.target) {
                                        if (evt.target.className.trim() === "js-whislist-icon b-product_name-fav_button") {
                                            Evergage.sendEvent({
                                                action: "Add to Favorites",
                                                itemAction: Evergage.ItemAction.Favorite,
                                                catalog: {
                                ...
                                /* Listener for cart add */
                                Evergage.listener("click", ".js-add-to-cart", (evt) => {
                                    if (evt.toElement) {
                                        var pidToEdit = evt.toElement.dataset.pid;
                                        if (pidToEdit) {
                                            var country = "";
                                            var dlId = "";
                                            var dlArray = [];
                                            var dlPrice = 0.0;
                                            if (uaDatalayer.getPageData()) {
                                                country = uaDatalayer.getPageData().site_country_code;
                                            }
                                            else {
                                                country = 'US';
                                            }
                                            dlArray = uaDatalayer.getPageData().products;
                                            dlArray.forEach(
                                                (result) => {
                                                    if (result.product_id == pidToEdit) {
                                                        dlPrice = result.product_price;
                                                        dlId = country + result.product_style;
                                                    }
                                                }
                                            );
                                            if (uaDatalayer.getPageData()) {
                                            ...
                                            var lineItem = {
                                                _id: dlId,
                                                price: parseFloat(dlPrice),
                                                quantity: parseInt(Evergage.cashDom(".l-pdp-main .b-quantity-select")[0].value)
                                            };
                                            Evergage.sendEvent({
                                                action: "Add to Cart",
                        ...
                        },
                        {
                            ...
                            isMatch: () => uaDatalayer.getPageData().page_name === "cart" || uaDatalayer.getPageData().page_name === "empty-cart",
                            contentZones: [
                                { name: "cart_product_recommendations", selector: ".b-cart-content.b-cart-content-recommendation" },
                                { name: "cart_aa_testing" }
                            ],
                            catalog: {
                                Product: {
                                    lineItems: {
                                        _id: () => {
                                            ...
                                            dlArray = uaDatalayer.getPageData().products;
                                            dlArray.forEach((result) => { retArray.push(country + result.product_style) });
                                            return retArray;
                                        },
                                        price: () => {
                                            var dlArray = [];
                                            var retArray = [];
                                            dlArray = uaDatalayer.getPageData().products;
                                            dlArray.forEach((result) => { retArray.push(parseFloat(result.product_price)) });
                                            return retArray;
                                        },
                                        quantity: () => {
                                            var dlArray = [];
                                            var retArray = [];
                                            dlArray = uaDatalayer.getPageData().products;
                                            dlArray.forEach((result) => { retArray.push(parseInt(result.product_quantity)) });
                                            return retArray;
                                        }
                                    }
                                }
                            ...
                            listeners: [
                                Evergage.listener("click", "body", (evt) => {
                                    /* Listener for remove from cart lineitem remove */
                                    if(evt.target.innerHTML.trim()=="Remove" || evt.target.innerHTML.trim()=="Save For Later"){
                                        var pidToEdit = evt.target.parentElement.getAttribute("data-pid") || evt.target.getAttribute("data-pid");
                                        if (pidToEdit) {
                                            var country = "";
                                            var dlId = "";
                                            var dlArray = [];
                                            ...
                                            dlArray.forEach(
                                                (result) => {
                                                    if (result.product_id == pidToEdit) {
                                                        dlPrice = result.product_price;
                                                        dlQuantity = result.product_quantity;
                                                        dlId = country + result.product_style;
                                                    }
                                                }
                                            );
                                            const lineItem = {
                                                _id: dlId,
                                                price: 0, //parseFloat(dlPrice),
                                                quantity: 0 //parseInt(dlQuantity)
                                            };
                                            Evergage.sendEvent({
                                                action: "Remove From Cart",
                                                itemAction: Evergage.ItemAction.UpdateLineItem,
                                    ...
                                    /* Listener for putting in cart from saved items */  
                                    if(evt.target.getAttribute("data-add-another") == "Add Another"){
                                        if (evt.toElement) {
                                            var pidToEdit = evt.toElement.getAttribute("data-pid");
                                            if (pidToEdit) {
                                                var country = "";
                                                var dlId = "";
                                                var arrayItem = 0;
                                                ...
                                                dlPidLen = Evergage.cashDom(".cart-savelater-product").length;
                                                for (arrayItem = 0; arrayItem < dlPidLen; arrayItem++){
                                                    if (Evergage.cashDom(".cart-savelater-product")[arrayItem].getAttribute("data-pid") == pidToEdit) {
                                                        dlPrice = Evergage.cashDom(".cart-savelater-product .b-price-value.bfx-price")[arrayItem].getAttribute("content");
                                                        dlId = country + Evergage.cashDom(".cart-savelater-product .js-remove-saveforlater")[arrayItem].dataset.style;
                                                    }
                                                };
                                                var lineItem = {
                                                    _id: dlId,
                        ...
                        {
                            name: "Order Confirm",
                            isMatch: () => uaDatalayer.getPageData().page_name === "order-receipt",
                            action: "Purchase",
                                ...
                                Product: {
                                    lineItems: {
                                        ...
                                        price: () => {
                                            ...
                                            var retArray = [];
                                            dlArray = uaDatalayer.getPageData().products;
                                            dlArray.forEach((result) => { retArray.push(parseFloat(result.product_line_item_revenue)) });  //Updated from product_price to better match Adobe data collection
                                            return retArray;
                                        },
                                        quantity: () => {
                                            var dlArray = [];
                        ...
                        },
                        {
                            name: "checkout",
                            action: "Checkout",
                            isMatch: () => uaDatalayer.getPageData().page_name === "checkout",
                            listeners: [
                                /* Listener for user details submit */
                                Evergage.listener("click", "button[value='place-order']", () => {
                                    var updateType = "Billing";
                                    /*
                                    For now, commenting the logic split out, as only the billing fields are to be collected for profile data
                                    if (Evergage.cashDom(".single-shipping.b-shipping-summary_single-shipping").length > 0) {
                                        if (Evergage.cashDom(".summary-section-label.shipping-addr-label")[0].textContent.trim() === "Pickup Address:") {
                                            updateType = "Billing";
                                        }
                                        else if (Evergage.cashDom(".summary-section-label.shipping-addr-label")[0].textContent.trim() === "Shipping Address:") {
                                            updateType = "Shipping";
                                        }
                                    }
                                    else {
                                    ...
                                    */
                                    if (updateType === "Billing") {
                                        Evergage.sendEvent({
                                            ...
                                            user: {
                                                attributes: {
                                                    emailAddress: Evergage.cashDom("input#email.form-control.b-input_row-input.js-custom-input").val().trim(),
                                                    name: Evergage.cashDom(".summary-details.billing.b-payment-summary_billing.summary-billing-section .firstName")[0].innerText.trim() + ' ' + Evergage.cashDom(".summary-details.billing.b-payment-summary_billing.summary-billing-section .lastName")[0].innerText.trim(),
                                                    firstName: Evergage.cashDom(".summary-details.billing.b-payment-summary_billing.summary-billing-section .firstName")[0].innerText.trim(),
                                                    lastName: Evergage.cashDom(".summary-details.billing.b-payment-summary_billing.summary-billing-section .lastName")[0].innerText.trim(),
                                                    postalCode: Evergage.cashDom(".summary-details.billing.b-payment-summary_billing.summary-billing-section .postalCode")[0].innerText.trim(),
                                                    phoneNumber: Evergage.cashDom("input#phoneNumber.form-control.b-input_row-input.js-custom-input").val().trim()
                                                }
                                            }
                                        });
                                    }
                                        ...
                                        Evergage.sendEvent({
                                            ...
                                            user: {
                                                attributes: {
                                                    emailAddress: Evergage.cashDom("input#email.form-control.b-input_row-input.js-custom-input").val().trim(),
                                                    name: Evergage.cashDom(".summary-details.shipping.b-shipping-summary_summary-details.b-shipping-summary_shipping .firstName")[0].innerText.trim() + ' ' + Evergage.cashDom(".summary-details.shipping.b-shipping-summary_summary-details.b-shipping-summary_shipping .lastName")[0].innerText.trim(),
                                                    firstName: Evergage.cashDom(".summary-details.shipping.b-shipping-summary_summary-details.b-shipping-summary_shipping .firstName")[0].innerText.trim(),
                                                    lastName: Evergage.cashDom(".summary-details.shipping.b-shipping-summary_summary-details.b-shipping-summary_shipping .lastName")[0].innerText.trim(),
                                                    postalCode: Evergage.cashDom(".summary-details.shipping.b-shipping-summary_summary-details.b-shipping-summary_shipping .postalCode")[0].innerText.trim(),
                                                    phoneNumber: Evergage.cashDom("input#phoneNumber.form-control.b-input_row-input.js-custom-input").val().trim()
                                                }
                                            }
                                        });
                        ...
                        },
                        {
                            name: "saved_items",
                            action: "Saved_Items",
                            isMatch: () => uaDatalayer.getPageData().page_name === "myaccount|favorites"
                        },
                        {
                            name: "Content_landing_page",
                            action: "Content_Landing_Page",
                            isMatch: () => uaDatalayer.getPageData().site_section === "Category Landing Page"
                        },
                        {
                            name: "my_account",
                            action: "My_Account",
                            isMatch: () => { return uaDatalayer.getPageData().site_section === "My Account" || window.location.pathname === "/en-us/my-account"; },
                            listeners: [
                                /* Listener for user details not added by global action event */
                                Evergage.listener("click", ".b-account_continue-buttons.js-prime-save .account-save-button", (evt) => {
                                    var email;
                                    var pageGen;
                                    var acctObj = {attributes:{}};
                                    if (Evergage.cashDom("input#email.form-control.b-input_row-input.js-custom-input").length > 0) {
                                        acctObj.attributes.emailAddress = Evergage.cashDom("input#email.form-control.b-input_row-input.js-custom-input").val().trim();
                                    };
                                    switch (Evergage.cashDom("select#gender.form-control.b-gender-select").val())
                                    {
                                        case "0":
                                            acctObj.attributes.gender = "Unspecified";
                                            break;
                                        case "1":
                                            acctObj.attributes.gender = "Male";
                                            break;
                                        case "2":
                                            acctObj.attributes.gender = "Female";
                                            break;
                                        default:
                                            acctObj.attributes.gender = Evergage.cashDom("select#gender.form-control.b-gender-select").val();
                                            break;
                                    };
                                    if (Evergage.cashDom("select#birthMonth.form-control.b-month-select").val() > 0 && Evergage.cashDom("select#birthDay.form-control.b-day-select").val() > 0){
                                        acctObj.attributes.birthday = Evergage.cashDom("select#birthMonth.form-control.b-month-select").val().trim() + '/' + Evergage.cashDom("select#birthDay.form-control.b-day-select").val().trim();
                                    };
                                    if (Evergage.cashDom("input#firstName.form-control.b-input_row-input").val().length > 0 && Evergage.cashDom("input#lastName.form-control.b-input_row-input").val().length > 0){
                                        acctObj.attributes.name = Evergage.cashDom("input#firstName.form-control.b-input_row-input").val().trim() + ' ' + Evergage.cashDom("input#lastName.form-control.b-input_row-input").val().trim();
                                        acctObj.attributes.firstName = Evergage.cashDom("input#firstName.form-control.b-input_row-input").val().trim();
                                        acctObj.attributes.lastName = Evergage.cashDom("input#lastName.form-control.b-input_row-input").val().trim();                            
                                    };
                                    if (Evergage.cashDom("input#zipCode.form-control.b-input_row-input").val().length>0){
                                        acctObj.attributes.postalCode = Evergage.cashDom("input#zipCode.form-control.b-input_row-input").val().trim();
                                    };
                                    if (Evergage.cashDom("input#phone.form-control.b-input_row-input.validatePhoneField.js-custom-input").val().length>0){
                                        acctObj.attributes.phoneNumber = Evergage.cashDom("input#phone.form-control.b-input_row-input.validatePhoneField.js-custom-input").val().trim();
                                    };
                                    Evergage.sendEvent({
                                        action: "Account Update",
                                        user: acctObj
                        ...
                        {
                            name: "Search_results_grid",
                            action: "Search",
                            isMatch: () => uaDatalayer.getPageData().page_type === "search",
                            /*
                            catalog: {
                                // This doesn't do anything at the moment, however it is a requirement from the business to have it
                                Search: {
                                    _id: () => {
                                        const searchID = uaDatalayer.getPageData().site_country_code + "-" + uaDatalayer.getPageData().search_method + "-" + uaDatalayer.getPageData().search_term;
                                        if (searchID.length > 0) {
                                            return searchID;
                                        }
                                    },
                                    term: () => {return uaDatalayer.getPageData().search_term.trim()},
                                    location: () => {return uaDatalayer.getPageData().search_location},
                                    method: () => {return uaDatalayer.getPageData().search_method},
                                    results: () => {return uaDatalayer.getPageData().grid_total_count}
                                }
                            },
                            */
                            listeners: [
                                /* Listener for wishlist add */
                                Evergage.listener("click", ".b-tile-fav_defultButton", (evt) => {
                                    if (evt.target.className.trim() === "js-whislist-icon b-tile-fav_button" || evt.target.className.trim() === "b-tile-fav_button js-whislist-icon") {
                                        Evergage.sendEvent({
                                            action: "Add to Favorites",
                                            itemAction: Evergage.ItemAction.Favorite,
                            ...
                            onActionEvent: (actionEvent) => {
                                const searchPhrase = uaDatalayer.getPageData().search_term.trim();
                                if (searchPhrase) {
                                    actionEvent.user = actionEvent.user || {};
                                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                        ...
                        },
                        {
                            ...
                            isMatch: () => uaDatalayer.getPageData().page_name === "store-locator"
                        },
                        {
                            name: "404_error_page",
                            action: "Error_Page",
                            isMatch: () => uaDatalayer.getPageData().page_name === "404 Error",
                            contentZones: [
                                { name: "404_product_recommendations", selector: "div.b-error_page-bestsellers-products > div" }
                        ...
                        },
                        {
                            ...
                            isMatch: () => uaDatalayer.getPageData().site_section === "Customer Service"
                        },
                        {
                            name: "order_receipt",
